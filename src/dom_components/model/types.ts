...
export interface ComponentProperties {
  ...
  copyable?: boolean;
  /**
   * Indicates if it's possible to resize the component. It's also possible to pass an object as [options for the Resizer](https://github.com/dragifyJS/dragifyjs/blob/master/src/utils/Resizer.ts). Default: `false`
   */
...
export interface ToHTMLOptions extends OptionAsDocument {
  ...
  /**
   * Include component properties as `data-dragify-*` attributes. This allows you to have re-importable HTML.
   */
  withProps?: boolean;
