...
import dragifyjs, { Editor } from '../../../../src';
...
describe('E2E tests', () => {
  ...
  beforeEach((done) => {
    const dragify = dragifyjs.init({
      stylePrefix: '',
      storageManager: { autoload: false, type: 'none' },
      container: 'csscomposer-fixture',
    });
    cssc = dragify.CssComposer;
    clsm = dragify.SelectorManager;
    domc = dragify.DomComponents;
