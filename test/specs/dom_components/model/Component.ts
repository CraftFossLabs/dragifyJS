...
describe('Component', () => {
  ...
  test('Component toHTML and withProps', () => {
    ...
    let res = `<div data-dragify-removable="false" data-dragify-bool="true" data-dragify-string="${resStr}" data-dragify-array="${resArr}" data-dragify-object="${resObj}" data-dragify-empty="" data-dragify-zero="0"></div>`;
    expect(obj.toHTML({ withProps: true })).toEqual(res);
    resStr = 'st&apos;ri"ng';
    resArr = '[1,"string",true]';
    resObj = '{"a":1,"b":"string","c":true}';
    res = `<div data-dragify-removable="false" data-dragify-bool="true" data-dragify-string='${resStr}' data-dragify-array='${resArr}' data-dragify-object='${resObj}' data-dragify-empty="" data-dragify-zero="0"></div>`;
  ...
  test('Ability to stop/change propagation chain', () => {
    ...
    newObj.components(`
      <div id="comp01">
        ...
        <div id="comp12" data-dragify-stop="1" data-dragify-removable="true" data-dragify-draggable="true" data-dragify-propagate='["stop"]'>
