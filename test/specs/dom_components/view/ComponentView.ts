...
describe('ComponentView', () => {
  ...
  test('Component empty', () => {
    expect(fixtures.innerHTML).toEqual(
      `<div data-dragify-highlightable="true" id="${el.id}" data-dragify-type="default"></div>`,
    );
  });
  ...
  test('Clean form helper state', () => {
    ...
    em.setState('');
    expect(fixtures.innerHTML).toEqual(
      `<div data-dragify-highlightable="true" id="${el.id}" data-dragify-type="default" class="selected"></div>`,
    );
  });
  ...
  test('Init with nested components', () => {
    ...
    expect(view.$el.html()).toEqual(
      `<span data-dragify-highlightable="true" id="${firstId}" data-dragify-type="default"></span><div data-dragify-highlightable="true" id="${secondId}" data-dragify-type="default" title="test"></div>`,
    );
  });
