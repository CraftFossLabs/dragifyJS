...
describe('ParserHtml', () => {
  ...
  test('Parse class string to array with special classes', () => {
    const str = 'test1 test2    test3 test-4 dragify-test';
    const result = ['test1', 'test2', 'test3', 'test-4', 'dragify-test'];
    expect(obj.parseClass(str)).toEqual(result);
  });
  ...
  test('Parse node with model attributes to fetch', () => {
    const str =
      '<div id="test1" data-test="test-value" data-dragify-draggable=".myselector" data-dragify-stuff="test">test2 </div>';
    const result = [
      {
        tagName: 'div',
  ...
  test('Parse model attributes with true and false', () => {
    const str =
      '<div id="test1" data-test="test-value" data-dragify-draggable="true" data-dragify-stuff="false">test2 </div>';
    const result = [
      {
        tagName: 'div',
        draggable: true,
  ...
  test('Parse attributes with object inside', () => {
    const str = '<div data-dragify-test=\'{ "prop1": "value1", "prop2": 10, "prop3": true}\'>test2 </div>';
    const result = [
      {
        tagName: 'div',
        type: 'text',
  ...
  test('Parse attributes with arrays inside', () => {
    const str = '<div data-dragify-test=\'["value1", "value2"]\'>test2 </div>';
    const result = [
      {
        tagName: 'div',
        type: 'text',
  ...
  describe('Options', () => {
    ...
    test('parsing as document', () => {
      const str = `
        <!DOCTYPE html>
        <html class="cls-html" lang="en" data-dragify-htmlp="true">
          <head class="cls-head" data-dragify-headp="true">
            <meta charset="utf-8">
            <title>Test</title>
          ...
          <body class="cls-body" data-dragify-bodyp="true">
            <h1>H1</h1>
          </body>
        </html>
      `;
